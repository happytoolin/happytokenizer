  ...
  return (
    <div className="hidden max-[900px]:block w-full">
      <div className="max-w-7xl mx-auto p-10 max-[1024px]:p-8 max-[900px]:p-4 max-[768px]:p-3 max-[480px]:p-2 mb-20 max-[768px]:mb-24 max-[600px]:mb-20 max-[480px]:mb-24">
        <div className="bg-gradient-to-br from-orange-50 to-white border border-brand-black shadow-hard-lg">
          <div className="p-6 flex flex-col gap-8 max-[768px]:p-4 max-[768px]:gap-6 max-[480px]:p-3 max-[480px]:gap-4">
            ...
            {/* Title */}
            <h3 className="font-display font-bold text-lg leading-tight text-center text-gray-900">
              Introducing LeapOCR
            </h3>

            {/* Description */}
            <p className="font-sans text-sm leading-relaxed text-center text-gray-600">
              Convert Documents to Markdown Instantly with AI-powered OCR
            </p>

            {/* Discount Badge */}
            <div className="bg-white p-3 rounded border border-gray-200 max-w-[320px] mx-auto">
